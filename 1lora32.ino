...
// ======== Pro UI (same UI, blue header says ESP32) ========
...
void wsEvent(uint8_t num, WStype_t type, uint8_t * payload, size_t len){
  if(type==WStype_TEXT){
    ...
    // Send to peer (ESP8266 address 1)
...
void setup(){
  ...
  Serial.println("✅ ESP32 WebChat ready at http://192.168.4.1");
}
